...
const routes: Routes=[
  ...
  { path: 'inscription', component: PageInscriptionComponent },
  {
    ...
    children: [
      ...
      { path: 'nouveau-fournisseur', component: NouveauCltFrsComponent, canActivate: [ApplicationGuardService], data: { origin: 'fournisseur' } },
      { path: 'nouveau-fournisseur/:id', component: NouveauCltFrsComponent, canActivate: [ApplicationGuardService], data: { origin: 'fournisseur' } },
