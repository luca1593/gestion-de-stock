...
class MvtstkService extends __BaseService {
  ...
  static readonly MvtStkApiFindAllGETPath='v1/mvtstk/all';
  static readonly MvtStkApiCorrectionMvtStkNegPOSTPath='v1/mvtstk/correction-neg';
  static readonly MvtStkApiFindMvtStkByDateMvtGETPath='v1/mvtstk/date/{dateMvtStk}';
  static readonly MvtStkApiEntreMvtStkPOSTPath='v1/mvtstk/entre';
  static readonly MvtStkApiMvtStkArticleGETPath='v1/mvtstk/filter/article/{idArticle}';
  static readonly MvtStkApiSavePOSTPath='v1/mvtstk/save';
  static readonly MvtStkApiSortieMvtStkPOSTPath='v1/mvtstk/sortie';
  static readonly MvtStkApiFindByIdGETPath='v1/mvtstk/{idMvtstk}';
  ...
  MvtStkApiCorrectionMvtStkPosPOSTResponse(body?: MvtStkDto): __Observable<__StrictHttpResponse<MvtStkDto>> {
    ...
    let req=new HttpRequest<any>(
      'POST',
      this.rootUrl + `v1/mvtstk/correction-pos`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  MvtStkApiDeleteDELETEResponse(typeMvt: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req=new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `v1/mvtstk/detele/${encodeURIComponent(String(typeMvt))}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  MvtStkApiStockReelArticleGETResponse(idArticle: number): __Observable<__StrictHttpResponse<number>> {
    ...
    let req=new HttpRequest<any>(
      'GET',
      this.rootUrl + `v1/mvtstk/stockreel/${encodeURIComponent(String(idArticle))}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  MvtStkApiFindMvtStkByTypeGETResponse(typeMvt: string): __Observable<__StrictHttpResponse<Array<MvtStkDto>>> {
    ...
    let req=new HttpRequest<any>(
      'GET',
      this.rootUrl + `v1/mvtstk/type/${encodeURIComponent(String(typeMvt))}`,
      __body,
      {
        headers: __headers,
        params: __params,
